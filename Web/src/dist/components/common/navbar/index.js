...
function Navbar(props) {
    return (react_1.default.createElement("div", { className: "sticky top-0 left-0 flex justify-between px-5 py-3 font-semibold text-2xl text-neutral-0 bg-primary-500 w-full select-none z-50" },
        props.label,
        props.buttonAction ?

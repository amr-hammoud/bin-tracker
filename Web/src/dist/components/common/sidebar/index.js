...
function Sidebar(props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col flex-wrap shadow-md bg-neutral-50 h-screen w-fit p-4" },
        react_1.default.createElement("div", { className: "flex justify-center w-fill mt-2 mb-8 text-xl rounded-md p-2\r\n\t\t\t\t\t\t\thover:bg-primary-400 hover:text-neutral-0 hover:cursor-pointer", onClick: () => setCollapse(!collapse) },
            react_1.default.createElement(lu_1.LuMenu, null)),
        react_1.default.createElement("div", { className: "w-full flex justify-center" }, collapse ? (react_1.default.createElement("img", { src: Logo_collapse_svg_1.default, className: " w-3/4", alt: "logo" })) : (react_1.default.createElement("img", { src: Logo_full_svg_1.default, className: "w-32", alt: "logo" }))),
        react_1.default.createElement("div", { className: `mt-8 ${collapse ? "flex flex-col justify-center" : ""}` }, (_a = props.items) === null || _a === void 0 ? void 0 : _a.map((item, index) => {
